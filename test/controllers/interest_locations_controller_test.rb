...
class InterestLocationsControllerTest < ActionController::TestCase
  ...
  test "should create interest_location" do
    assert_difference('InterestLocation.count') do
      post :create, interest_location: { box_radius: @interest_location.box_radius, latitude: @interest_location.latitude, longitude: @interest_location.longitude, user_id: @interest_location.user_id }
    end
  ...
  test "should update interest_location" do
    patch :update, id: @interest_location, interest_location: { box_radius: @interest_location.box_radius, latitude: @interest_location.latitude, longitude: @interest_location.longitude, user_id: @interest_location.user_id }
    assert_redirected_to interest_location_path(assigns(:interest_location))
  end
